export default {
	...
	init_ui() {
		...
		console.log(this.__LOG_TAG__, "[Loading] ui_catalog_search_bar models...");
		var __debug_search_bar = ui_catalog_search_bar.refresh();
		console.log(this.__LOG_TAG__, "[OK] ui_catalog_search_bar inited...", __debug_search_bar);
